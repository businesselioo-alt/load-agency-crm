...
import {
  LayoutDashboard, Users, Settings, LogOut, MessageSquare, TrendingUp, Calculator, X, Radio,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { href: '/dashboard/direct',    label: 'Chatting direct', icon: Radio,      modules: ['dashboard'] },
